...
title('Plot of actual and estimated values of $V_R$ using the Least Squares Method','Interpreter','latex','fontsize',14)
...
grid on
title('Plot of error $e = V_R - \hat{V}_R$', 'interpreter', 'latex','fontsize',14)
...
l = legend('$V_C$');
set(l, 'interpreter', 'latex')
title('Plot of actual and estimated values of $V_C$ using the Least Squares Method','Interpreter','latex','fontsize',14)
...
ylabel('Error e(t)', 'interpreter', 'latex','fontsize',14)
grid on
title('Plot of error $e = V_C - \hat{V}_C$', 'interpreter', 'latex','fontsize',14)